...
$(document).on('ready', function() {
    ...
    //     func_initFacultySlider();
	// }

	// if(typeof initAdjustSliceGrid !== 'undefined') {
	// 	adjustSliceGrid();
	// }
...
$(window).resize(function() {
    ...
    // if (($("#mqCheck-767").is(':visible')) || (facultySliderLoaded == false)) {
    //     func_initFacultySlider();
    // }
	
	// if(typeof initAdjustSolutionsGrid !== 'undefined') {
	// 	adjustSolutionsGrid();
	// }
...
var highlightActivePage = function() {
    ...
    if(typeof activeHeaderBrand !== 'undefined') {
		$('.' + activeHeaderBrand).addClass('brand');
	}
	if(typeof activeHeaderBright !== 'undefined') {
		$('.' + activeHeaderBright).addClass('bright');
	}
};
...
$(".scrollLink").click(function(e) {
	...
	$('html, body').animate({
		scrollTop: $('.scroll-top').offset().top - 80
	}, 500);
});
